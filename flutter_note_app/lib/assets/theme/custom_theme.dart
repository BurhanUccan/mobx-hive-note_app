...
final ThemeData myDarkTheme = ThemeData(
  ...
  colorScheme: ColorScheme(
    ...
    onPrimary: Colors.grey.withOpacity(.2), //buton renkleri için
    secondary: Colors.white, // yazı için kullanıldı
    onSecondary: Colors.grey,
    background: const Color(0xFF121212),
    surface: const Color(0xfffe6902),
  ...
  indicatorColor: const Color(0xfffe6902),
